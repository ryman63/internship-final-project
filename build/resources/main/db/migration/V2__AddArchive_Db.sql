...
create table archived_performance (id int8 generated by default as identity, status varchar(255), task_name varchar(255), archived_participant_id int8 not null, primary key (id));
create table fork (id int8 generated by default as identity, git_lab_repository_id varchar(255), lesson_id int8 not null, task_id int8 not null, participant_id int8 not null, primary key (id));
...
alter table if exists fork add constraint FK_fork_participant foreign key (participant_id) references participant;
